...
public class OrdenReaprovicionamientoLogicServiceTest {
	...
	private void insertData() {
		for(int i=0;i<3;i++){
			...
			pdto.setNombreMateria(generateRandom(String.class));
	...
	public void createOrdenReaprovicionamientoTest(){
		...
		ldto.setNombreMateria(generateRandom(String.class));
		...
		Assert.assertEquals(ldto.getNombreMateria(), pdto.getNombreMateria());	
	}
	...
	public void getOrdenReaprovicionamientoTest(){
		...
		Assert.assertEquals(pdto.getNombreMateria(), ldto.getNombreMateria());
	...
	public void updateOrdenReaprovicionamientoTest(){
		...
		Assert.assertEquals(ldto.getNombreMateria(), resp.getNombreMateria());	
	}
