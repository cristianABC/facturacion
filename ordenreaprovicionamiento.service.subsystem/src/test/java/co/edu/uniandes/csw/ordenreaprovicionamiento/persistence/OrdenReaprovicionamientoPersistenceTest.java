...
public class OrdenReaprovicionamientoPersistenceTest {
	...
	private void insertData() {
		for(int i=0;i<3;i++){
			...
			entity.setNombreMateria(generateRandom(String.class));
			em.persist(entity);
			data.add(entity);
		}
	}
	...
	public void createOrdenReaprovicionamientoTest(){
		...
		dto.setNombreMateria(generateRandom(String.class));
		...
		Assert.assertEquals(dto.getNombreMateria(), entity.getNombreMateria());	
	}
	...
	public void getOrdenReaprovicionamientoTest(){
		...
		Assert.assertEquals(entity.getNombreMateria(), dto.getNombreMateria());
	...
	public void updateOrdenReaprovicionamientoTest(){
		...
		Assert.assertEquals(dto.getNombreMateria(), resp.getNombreMateria());	
	}
